...
class AgentID$Type extends MessageType<AgentID> {
    ...
    create(value?: PartialMessage<AgentID>): AgentID {
        ...
        message.gid = 0;
        if (value !== undefined)
            reflectionMergePartial<AgentID>(this, message, value);
        return message;
    }
    ...
    internalBinaryWrite(message: AgentID, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* int32 gid = 2; */
        if (message.gid !== 0)
            writer.tag(2, WireType.Varint).int32(message.gid);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class Rubble$Type extends MessageType<Rubble> {
    ...
    internalBinaryWrite(message: Rubble, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.moveCost !== 0)
            writer.tag(1, WireType.Varint).int32(message.moveCost);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class Cell$Type extends MessageType<Cell> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* aegis.Survivor survivor */ 5:
                    message.topLayer = {
                        oneofKind: "survivor",
                        survivor: Survivor.internalBinaryRead(reader, reader.uint32(), options, (message.topLayer as any).survivor)
                    };
                    break;
                case /* aegis.Rubble rubble */ 6:
                    message.topLayer = {
                        oneofKind: "rubble",
                        rubble: Rubble.internalBinaryRead(reader, reader.uint32(), options, (message.topLayer as any).rubble)
                    };
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: Cell, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.agentIds.length; i++)
            AgentID.internalBinaryWrite(message.agentIds[i], writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        ...
        if (message.topLayer.oneofKind === "survivor")
            Survivor.internalBinaryWrite(message.topLayer.survivor, writer.tag(5, WireType.LengthDelimited).fork(), options).join();
        /* aegis.Rubble rubble = 6; */
        if (message.topLayer.oneofKind === "rubble")
            Rubble.internalBinaryWrite(message.topLayer.rubble, writer.tag(6, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class WorldState$Type extends MessageType<WorldState> {
    ...
    create(value?: PartialMessage<WorldState>): WorldState {
        ...
        message.survivors = [];
        if (value !== undefined)
            reflectionMergePartial<WorldState>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: WorldState): WorldState {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: WorldState, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.survivors.length; i++)
            Survivor.internalBinaryWrite(message.survivors[i], writer.tag(5, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class GroupData$Type extends MessageType<GroupData> {
    ...
    create(value?: PartialMessage<GroupData>): GroupData {
        ...
        if (value !== undefined)
            reflectionMergePartial<GroupData>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GroupData): GroupData {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GroupData, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* int32 gid = 1; */
        if (message.gid !== 0)
            writer.tag(1, WireType.Varint).int32(message.gid);
        /* string name = 2; */
        if (message.name !== "")
...
class RoundUpdate$Type extends MessageType<RoundUpdate> {
    ...
    create(value?: PartialMessage<RoundUpdate>): RoundUpdate {
        ...
        message.groups = [];
        if (value !== undefined)
            reflectionMergePartial<RoundUpdate>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: RoundUpdate): RoundUpdate {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: RoundUpdate, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.world)
            WorldState.internalBinaryWrite(message.world, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        /* repeated aegis.GroupData groups = 3; */
        for (let i = 0; i < message.groups.length; i++)
            GroupData.internalBinaryWrite(message.groups[i], writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class SimulationState$Type extends MessageType<SimulationState> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SimulationState): SimulationState {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: SimulationState, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.maxRounds !== 0)
            writer.tag(2, WireType.Varint).int32(message.maxRounds);
...
class WorldStats$Type extends MessageType<WorldStats> {
    ...
    create(value?: PartialMessage<WorldStats>): WorldStats {
        ...
        message.stepsTaken = 0;
        if (value !== undefined)
            reflectionMergePartial<WorldStats>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: WorldStats): WorldStats {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
...
class GroupStats$Type extends MessageType<GroupStats> {
    ...
    create(value?: PartialMessage<GroupStats>): GroupStats {
        ...
        if (value !== undefined)
            reflectionMergePartial<GroupStats>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GroupStats): GroupStats {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
...
class RoundData$Type extends MessageType<RoundData> {
    ...
    create(value?: PartialMessage<RoundData>): RoundData {
        ...
        message.groupsData = [];
        if (value !== undefined)
            reflectionMergePartial<RoundData>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: RoundData): RoundData {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                ...
                case /* aegis.WorldState after_world */ 3:
                    message.afterWorld = WorldState.internalBinaryRead(reader, reader.uint32(), options, message.afterWorld);
                    break;
    ...
    internalBinaryWrite(message: RoundData, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.afterWorld)
            WorldState.internalBinaryWrite(message.afterWorld, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        /* repeated aegis.GroupData groups_data = 4; */
        for (let i = 0; i < message.groupsData.length; i++)
            GroupData.internalBinaryWrite(message.groupsData[i], writer.tag(4, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class SimulationComplete$Type extends MessageType<SimulationComplete> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SimulationComplete): SimulationComplete {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: SimulationComplete, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class SimulationEvent$Type extends MessageType<SimulationEvent> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SimulationEvent): SimulationEvent {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* aegis.WorldState world_init */ 1:
                    message.event = {
                        oneofKind: "worldInit",
                        worldInit: WorldState.internalBinaryRead(reader, reader.uint32(), options, (message.event as any).worldInit)
                    };
                    break;
                case /* aegis.RoundUpdate round_update */ 2:
                    message.event = {
                        oneofKind: "roundUpdate",
                        roundUpdate: RoundUpdate.internalBinaryRead(reader, reader.uint32(), options, (message.event as any).roundUpdate)
                    };
                    break;
                case /* aegis.SimulationComplete complete */ 3:
                    message.event = {
                        oneofKind: "complete",
                        complete: SimulationComplete.internalBinaryRead(reader, reader.uint32(), options, (message.event as any).complete)
                    };
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: SimulationEvent, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.event.oneofKind === "worldInit")
            WorldState.internalBinaryWrite(message.event.worldInit, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* aegis.RoundUpdate round_update = 2; */
        if (message.event.oneofKind === "roundUpdate")
            RoundUpdate.internalBinaryWrite(message.event.roundUpdate, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        /* aegis.SimulationComplete complete = 3; */
        if (message.event.oneofKind === "complete")
            SimulationComplete.internalBinaryWrite(message.event.complete, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
