...
//   private currentWorld?: schema.World
//   private rounds: schema.Round[] = []
//
...
//    */
//   private getCellTypeFromProtobuf(cell: schema.Cell): string {
...
//    */
//   getSpawnInfo(x: number, y: number): schema.Location | undefined {
