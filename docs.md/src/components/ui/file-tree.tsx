  ...
  return (
    <div
      className={cn(
        ...
        children &&
          type === "folder" &&
          "before:absolute before:left-[7px] before:top-7 before:bottom-0 before:w-px before:bg-gray-800",
      )}
    >
      <div
        className={cn(
...
const FileTree = ({ children }: { children: React.ReactNode }) => {
  return (
    <div className="bg-zinc-950 border border-gray-800 shadow-sm p-4 rounded-lg text-gray-300">
      {children}
    </div>
  );
};
