...
### <div className="font-medium font-mono">get_world_grid()</div>
...
### <div className="font-medium font-mono">get_cell_at(location: Location)</div>
...
### <div className="font-medium font-mono">on_map(location: Location)</div>
