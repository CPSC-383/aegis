import { allGuidesMAS } from "content-collections";
...
async function getDocFromParams({ params }: Props) {
  ...
  const entry = allGuidesMAS.find((entry) => {
