          ...
          <div>
            ...
            <blockquote className="border-l-4 border-light-primary dark:border-dark-primary pl-6 italic my-8">
              <p className="text-lg text-muted-foreground">
                Aegis, pronounced "ee-jis," originates from ancient Greek,
                meaning "shield", "protection" or "support."
              </p>
              <p className="text-lg text-muted-foreground mt-2">
                In the context of your assignment, Aegis symbolizes the
                protective role of agents as they save survivors.
              </p>
            </blockquote>
          </div>
