  ...
  return (
    <Collapsible
      ...
      className={cn(
        ...
        // Futuristic border and background matching your theme
    ...
    >
      <CollapsibleTrigger
        className={cn(
          ...
          // Border styling to match your theme
          'border-b border-cyan-500/20 group-data-[state=open]:border-cyan-400/30',
          // Hover effects matching your card styling
