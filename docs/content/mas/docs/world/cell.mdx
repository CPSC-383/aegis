...
whether it contains survivors and the agents on the cell. It also supports advanced features, including layered
...
<Attribute
  name="agent_id_list"
  type="AgentIDList"
  description="List of agent IDs present in the cell."
/>
<Attribute
  name="move_cost"
  type="int"
