...
If the output doesn't show `Python 3.12.10`, follow the [Python Setup Guide](/mas/guides/python-setup) to install it and then come back. 
...
To verify that everything is working as expected, run aegis with one of the methods in the [Running Aegis section](/mas/getting-started/running-aegis).
