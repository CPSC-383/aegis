...
<div className="text-xl mt-8 font-mono">[END_TURN](/mas/docs/agent-commands/end-turn)</div>
<div className="text-xl mt-4 font-mono">[MOVE](/mas/docs/agent-commands/move)</div>
<div className="text-xl mt-4 font-mono">[OBSERVE](/mas/docs/agent-commands/observe)</div>
<div className="text-xl mt-4 font-mono">[PREDICT](/mas/docs/agent-commands/predict)</div>
<div className="text-xl mt-4 font-mono">[SAVE_SURV](/mas/docs/agent-commands/save-surv)</div>
<div className="text-xl mt-4 font-mono">[SLEEP](/mas/docs/agent-commands/sleep)</div>
<div className="text-xl mt-4 font-mono">[TEAM_DIG](/mas/docs/agent-commands/team-dig)</div>
