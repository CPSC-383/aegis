...
<div className="text-xl mt-8 font-mono">[END_TURN](/pathfinding/docs/agent-commands/end-turn)</div>
<div className="text-xl mt-4 font-mono">[MOVE](/pathfinding/docs/agent-commands/move)</div>
<div className="text-xl mt-4 font-mono">[SAVE_SURV](/pathfinding/docs/agent-commands/save-surv)</div>
<div className="text-xl mt-4 font-mono">[SLEEP](/pathfinding/docs/agent-commands/sleep)</div>
