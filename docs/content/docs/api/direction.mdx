...
<PyAttribute type="" value="(0, 1)" docString="Direction that points north (up)." />

### NORTHEAST

<PyAttribute type="" value="(1, 1)" docString="Direction that points northeast (up and right)." />

### EAST

<PyAttribute type="" value="(1, 0)" docString="Direction that points east (right)." />

### SOUTHEAST

<PyAttribute type="" value="(1, -1)" docString="Direction that points southeast (down and right)." />

### SOUTH

<PyAttribute type="" value="(0, -1)" docString="Direction that points south (down)." />

### SOUTHWEST

<PyAttribute type="" value="(-1, -1)" docString="Direction that points southwest (down and left)." />

### WEST

<PyAttribute type="" value="(-1, 0)" docString="Direction that points west (left)." />

### NORTHWEST

<PyAttribute type="" value="(-1, 1)" docString="Direction that points northwest (up and left)." />

### CENTER

<PyAttribute type="" value="(0, 0)" docString="Direction that points center (not moving)." />
