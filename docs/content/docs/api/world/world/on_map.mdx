...
A location is considered on the map if both its x and y coordinates are greater than or equal to 0, and strictly less than the world's width and height, respectively.
