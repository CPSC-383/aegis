...
<Method
  name="get_agent_id"
  description="Returns the AgentID of the agent."
  returns={{
    type: "AgentID",
    description: "The AgentID of the agent.",
  }}
/>
...
```py
agent_id = self._agent.get_agent_id()
print(agent_id)
# Output: (1, 5) 
```
