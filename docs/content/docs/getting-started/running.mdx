...
Here's an example of running Aegis with a sample agent, `ExampleWorld.world` and 50 rounds:
...
options:
  ...
  --config CONFIG  Config preset to use (default: default)
...
If you accidentally select the wrong path, you can reconfigure it anytime from the **Settings** tab. 
</Callout> 
...
Navigate to the **Aegis** tab and select the world, agent, group name, number of rounds, and configuration
preset you wish to use.
