...
## [2.4.0](https://github.com/AEGIS-GAME/aegis/compare/v2.3.0...v2.4.0) (2025-08-16)


### Features

* ✨ pr template ([fee7735](https://github.com/AEGIS-GAME/aegis/commit/fee7735455a45add345f58212237f6440cdbd4d2))
* ✨ pr template ([d620cb4](https://github.com/AEGIS-GAME/aegis/commit/d620cb43c4d20332f91c3fbf0d3a3e732f8d92b8))
* **a lot of stuff:** sidebar, starting games, grab output and error, etc. ([e16f73f](https://github.com/AEGIS-GAME/aegis/commit/e16f73f31752e8969c86c111cf7c7452e7eeaff3))
* **a3 aegis commands:** add aegis commands for a3 ([bbd80d5](https://github.com/AEGIS-GAME/aegis/commit/bbd80d597c3ab5e6927cae12e8deeae75e44e99b))
* **a3 agent commands:** add agent commands for a3 ([a92a47e](https://github.com/AEGIS-GAME/aegis/commit/a92a47e56bbc037cfc94bf8725e59f3acce84858))
* **a3 doc stuff:** add more a3 doc stuff and some fixes ([86e32e9](https://github.com/AEGIS-GAME/aegis/commit/86e32e96ded8a914769d9b120ec7580bcf1ad51b))
* **a3 docs and assignment env var:** started a3 docs, and show docs based on assignment env var ([4781c73](https://github.com/AEGIS-GAME/aegis/commit/4781c735c71f2524fb2dda452e3a7b598734101b))
* **a3 docs more:** feat(a3 docs more):  ([dd57e0d](https://github.com/AEGIS-GAME/aegis/commit/dd57e0d18a12a5d1c2403fa14a7634b1a1a39e87))
* add cooldown ([#277](https://github.com/AEGIS-GAME/aegis/issues/277)) ([daa2039](https://github.com/AEGIS-GAME/aegis/commit/daa2039444cf4c7056eba2a3dda440241ac4a16a))
* **API:** create an api so its easier and cleaner to import things ([83ae7d1](https://github.com/AEGIS-GAME/aegis/commit/83ae7d174b7745712e4a4a5049d84156d4e29674))
* **attributes :** search attributes feature ([aa6ff99](https://github.com/AEGIS-GAME/aegis/commit/aa6ff9965616f86919c803ce10d108628c3ae92a))
* **convert electron stuff to rust:** convert the electron IPC calls to rust code ([fbc4abf](https://github.com/AEGIS-GAME/aegis/commit/fbc4abf20aebe3d2dad34532f0806313f3f9361b))
* **direction_to:** add direction_to function ([4bb8ecc](https://github.com/AEGIS-GAME/aegis/commit/4bb8eccd932f1d3645d1b343bf75bc4e1f7bd0eb))
* **docs layout:** finally got something that works and looks good ([c3f8503](https://github.com/AEGIS-GAME/aegis/commit/c3f85032591030555a4fa126d179093a8ad6c405))
* **docs overhaul:** a lot of UI changes ([9cb7da9](https://github.com/AEGIS-GAME/aegis/commit/9cb7da9dff6ce6ba2234838876fd74370f1adea5))
* **finish a1 docs:** finally finished a1 docs ([6af650f](https://github.com/AEGIS-GAME/aegis/commit/6af650f62d560ad9e5f7283b075a34156ce27838))
...
* **for fun and map generator:** add a map generator and the for fun map ([bff2a7e](https://github.com/AEGIS-GAME/aegis/commit/bff2a7ef4611b73e79f3f7d4fd1436477ffe740e))
* **game area and control bar:** add the game area and control bar ([a013e12](https://github.com/AEGIS-GAME/aegis/commit/a013e12437abe643f6035d4d12ef87478727fb9b))
* **git intro and setup:** add a page for git intro and setup ([ce05ecf](https://github.com/AEGIS-GAME/aegis/commit/ce05ecf602fd01f8d85cf6ebb2b0ffd4950d4bce))
* **icons:** added icons to the search, removed the use effect logs, and fix the headers ([9fcf722](https://github.com/AEGIS-GAME/aegis/commit/9fcf7225c2faaef74ec11478dc0acb4a05dba504))
* **icons:** added icons to the search, removed the use effect logs, and fix the headers ([abf5984](https://github.com/AEGIS-GAME/aegis/commit/abf59840d65c61385af5a206e27237f4334b4aa6))
* **lumens:** added lumens ([#276](https://github.com/AEGIS-GAME/aegis/issues/276)) ([74bb013](https://github.com/AEGIS-GAME/aegis/commit/74bb013f0904b851f28d30387eaca5e2ddb12979))
* **method search:** added simple method search, need to finish adding names for all methods ([7de2001](https://github.com/AEGIS-GAME/aegis/commit/7de200173813ce093fabecb5e63d0eb3bf51dc2f))
* **nav config:** central config for nav items ([051e3f8](https://github.com/AEGIS-GAME/aegis/commit/051e3f858bf120a0f499fc0b065e2a9156c54ac5))
* **navbar:** add navbar ([ff628bb](https://github.com/AEGIS-GAME/aegis/commit/ff628bbf3f943be1289db303f6e1b808ea9a1dc1))
* **next mdx:** finally got mdx working, still some small problems like ul and li not getting styles applied. Did it manually for now. ([3df9ff0](https://github.com/AEGIS-GAME/aegis/commit/3df9ff0ae336473932cd7c5d5c18a50f6e431932))
* **reload data:** switching tabs reloads data ([4370ddc](https://github.com/AEGIS-GAME/aegis/commit/4370ddca0ed4e63aea77f09b4fc4257c8fab8a0c))
* **script and client no venv:** made the client and script work without having the venv activated ([0a4d75c](https://github.com/AEGIS-GAME/aegis/commit/0a4d75caf76044758ca2082fc87cc58682fce20f))
* **scroll progress and footer:** add a scroll progress for docs and a footer ([71de281](https://github.com/AEGIS-GAME/aegis/commit/71de28151c7ea6d784fa014193bc325040565e83))
* **search:** add ability to search api ([376740e](https://github.com/AEGIS-GAME/aegis/commit/376740ea3696dd1b3a9f31d80d60f88142e8e993))
* **setup:** check if packages needs installing, and add colours ([cd719bc](https://github.com/AEGIS-GAME/aegis/commit/cd719bc2567abb0a7d366fa32d46810719143253))
* **setup:** check python version in setup script ([3310fba](https://github.com/AEGIS-GAME/aegis/commit/3310fbae766f08dbff3f32eae6e46f5e767248c0))
* **setup:** setup script and clean code ([b955c97](https://github.com/AEGIS-GAME/aegis/commit/b955c97517330ac3daec0e77e3e62725bcd863c8))
* **tab headers:** fix headers in tabs. Only display for system ([897be0b](https://github.com/AEGIS-GAME/aegis/commit/897be0b871500f719f57909bd566981c030e0b67))
* **theme toggle:** add theme toggle in navbar ([e7c469f](https://github.com/AEGIS-GAME/aegis/commit/e7c469f9e432db56ad3f5bb5b910fe21ec4212cc))
* **toc:** added toc ([8165507](https://github.com/AEGIS-GAME/aegis/commit/8165507f1601e94efba6340ec4cb4834bdb9a8fc))
* **too lazy to describe changes:** in short: fix and added stuff ([ae46c8f](https://github.com/AEGIS-GAME/aegis/commit/ae46c8fcbc6531b9a88bbaf89390b4e24c065bfd))
* **types:** added agent types  ([#274](https://github.com/AEGIS-GAME/aegis/issues/274)) ([b82db85](https://github.com/AEGIS-GAME/aegis/commit/b82db85986d8f6f65f3a4bb3596f4f68364ea4ba))
* **ui :** add a button, and fix key issue ([f1d1e17](https://github.com/AEGIS-GAME/aegis/commit/f1d1e17f56af520c334f897e6d2fad875b67a004))
* **workflow:** auto build client on release (might not work) ([bac7197](https://github.com/AEGIS-GAME/aegis/commit/bac71973f9c85665f9b4b83120b5941436a06956))


### Bug Fixes

* **__repr__:** add __repr__ to common classes ([e85d4b6](https://github.com/AEGIS-GAME/aegis/commit/e85d4b60c65c33136aa156415eb232a41e2e9816))
* **7z:** relative path so 7z compresses clients properly without the parent dirs ([a007e44](https://github.com/AEGIS-GAME/aegis/commit/a007e44d1573206db7b0d99cf57e7385d3783c41))
* **a*:** better a* ([4707b0c](https://github.com/AEGIS-GAME/aegis/commit/4707b0ca0fd25f939dcea7434d2824c08b23fdea))
* **a1 sleep result:** add sleep result to update energy ([1568168](https://github.com/AEGIS-GAME/aegis/commit/15681687d013300a9ffb16ff8154f2531c818439))
* **a1 sleep result:** add sleep result to update energy ([cb115fa](https://github.com/AEGIS-GAME/aegis/commit/cb115fa75ce62e645eb15cc59c7cfafcf698f3da))
* **a3 brain:** fix aegisparser import ([5d4e475](https://github.com/AEGIS-GAME/aegis/commit/5d4e475babf8ef963e378847d3908811af50716f))
* **aegis:** :sparkles: subtract energy for erroring agents ([#261](https://github.com/AEGIS-GAME/aegis/issues/261)) ([c0bd17d](https://github.com/AEGIS-GAME/aegis/commit/c0bd17d331f5ab543419166fb902c85962748b2f))
* **agent_id_list mas:** cells didnt update the AgentIDList ([32c313f](https://github.com/AEGIS-GAME/aegis/commit/32c313fb58e73bd705a93e46188fb8ac667dbf0d))
* **assignment version check:** add assignment version check to hide some stuff from search ([f1e75f1](https://github.com/AEGIS-GAME/aegis/commit/f1e75f121ffe86cdd6a243365e2d76c199836408))
* **better_agent:** loc after removing all layers ([8053cd6](https://github.com/AEGIS-GAME/aegis/commit/8053cd67bb9b6a9b9e74e9f30e5449cf83787a46))
* **bool:** windows boolean ([6559111](https://github.com/AEGIS-GAME/aegis/commit/6559111bc724f67a9d7cd48b456c5196a7f176f7))
* **border:** admonition borde didn't have colour ([dda1f74](https://github.com/AEGIS-GAME/aegis/commit/dda1f74a1995d175032e9d5872cd6ccf52c65dfe))
...
* **code block wrap:** fix code blocks not wrapping ([aa9c8d9](https://github.com/AEGIS-GAME/aegis/commit/aa9c8d961f4ebb49e0efdf61959a2a72b99192ec))
* **codeblock:** dont wrap, but scroll instetad ([a2c2e63](https://github.com/AEGIS-GAME/aegis/commit/a2c2e63d97bbf48be6744f84642daec9ce3a71f3))
* **config:** set move cost to default, and get rid of Config struct in lib.rs ([6aee624](https://github.com/AEGIS-GAME/aegis/commit/6aee624531bb12493c7aaf66d43692c453d39050))
* **custom hide width:** add lg-custom to hide a 1024px ([f1fd8e7](https://github.com/AEGIS-GAME/aegis/commit/f1fd8e7f4ce66e55717038fe34801be0774441ce))
* **default energy:** set default energy for survivors to 100 instead of 0 ([36bf8d3](https://github.com/AEGIS-GAME/aegis/commit/36bf8d35f5b0af6302ace18c8d3218156a95d349))
* **docs and workflow:** fix outdated info in docs, and zip aegis folder properly so it's easier to unzip ([7dbf52a](https://github.com/AEGIS-GAME/aegis/commit/7dbf52aac5799ddd4b5642f4d23dcf5da1364868))
* **docs stuff:** fix doc to agent controller and typo ([550fc67](https://github.com/AEGIS-GAME/aegis/commit/550fc67b360ac10c19f6c05f5aba24585403fdd0))
* **docs workflow:** path ([1a862f4](https://github.com/AEGIS-GAME/aegis/commit/1a862f477191c5c86b34eaf4332e790683f6321d))
* **error:** show error message on import fail ([1250464](https://github.com/AEGIS-GAME/aegis/commit/12504644b8a9bd5f226d53a3c67febc3ac5616cd))
* **example_agent:** fix that ([e910055](https://github.com/AEGIS-GAME/aegis/commit/e91005500f6045c1e51f2ccb137c8f1123f76d38))
* **export world:** add the export world stuff ([02bcefc](https://github.com/AEGIS-GAME/aegis/commit/02bcefc2a74f82c0876c0dd812e6627546f792d8))
* **export world:** add the export world stuff ([77e09e4](https://github.com/AEGIS-GAME/aegis/commit/77e09e4d7669b16a7ea896f4650dc2e62890c94c))
* **few typos:** fix the typos ([45287e1](https://github.com/AEGIS-GAME/aegis/commit/45287e16d57892d1abf64ac7c1d70bd3c8bd3bce))
* **font mono:** remove mono on some stuff ([6fea02e](https://github.com/AEGIS-GAME/aegis/commit/6fea02ebf99390989d8df73f449896ef13c69fc1))
* **forgot a spot:** fix(forgot a spot):  ([8a25a81](https://github.com/AEGIS-GAME/aegis/commit/8a25a8197916e0d2d6c0d09ca59051fd0908ec6a))
* **fwd message:** fix(fwd message):  ([7b9c9f7](https://github.com/AEGIS-GAME/aegis/commit/7b9c9f755b80f560cd4a329411f56b985003c252))
...
* **getting started path:** fix the path for getting started stuff ([cf6a2cf](https://github.com/AEGIS-GAME/aegis/commit/cf6a2cf7c0d80ca216a29d0b57e0283956c93dd6))
* **gitignore:** and some more stuff to ignore ([d8dd3c3](https://github.com/AEGIS-GAME/aegis/commit/d8dd3c38b6d06afe04a4622476c58ca7c2820801))
* **grid type :** fix grid type for read_and_build_grid() ([07c79f1](https://github.com/AEGIS-GAME/aegis/commit/07c79f136bebe69b20744b7f03ed08606078797e))
* **href home docs:** fix href for home page to the docs ([b356d72](https://github.com/AEGIS-GAME/aegis/commit/b356d72fd44e57aa7e6c7ba6544f022ddb2f8d0e))
* **images not rendering:** fix images not rendering when deployed ([2becc86](https://github.com/AEGIS-GAME/aegis/commit/2becc86629cd66b9d8cb201e4ebea25c35ee8450))
* **images not rendering:** fix images not rendering when deployed ([5abd341](https://github.com/AEGIS-GAME/aegis/commit/5abd341410f1506793ca0de4d8fe4087f118d393))
* **import loop:** python sucks ([0049938](https://github.com/AEGIS-GAME/aegis/commit/0049938af6cf0a7771498a5c86aea9e18ef6ceba))
* **links:** install links 404 ([785fa59](https://github.com/AEGIS-GAME/aegis/commit/785fa59fc9ba62ac68b2ae2d97a49e470df8e43e))
* **linux tauri:** fix conf again ([20d42c4](https://github.com/AEGIS-GAME/aegis/commit/20d42c4dacac5e59d2a6a0588e34d27c9f1b9f9a))
* **linux tauri:** fix linux tauri conf ([96eec30](https://github.com/AEGIS-GAME/aegis/commit/96eec303350c355143540e3bd8b41ac73df673b6))
* **map agent_energy problem:** took it from the object in map creation ([3a2ebd6](https://github.com/AEGIS-GAME/aegis/commit/3a2ebd6d5faafba412e365b8c4e97f434919391f))
* **map agent_energy problem:** took it from the object in map creation ([48b8a6e](https://github.com/AEGIS-GAME/aegis/commit/48b8a6e3d20a447f569b5137623374f8de0b2973))
* **map:** . ([aca86f4](https://github.com/AEGIS-GAME/aegis/commit/aca86f4a6b1fad076caac92beb0ac628db5e7485))
...
* **move cost toggle:** fix the move cost toggle in the settings ([8069f00](https://github.com/AEGIS-GAME/aegis/commit/8069f002e781b55764de582f405937ca28aa268c))
* **move toggle:** add move cost toggle to config ([a3b0dc5](https://github.com/AEGIS-GAME/aegis/commit/a3b0dc597af4111c9479b4128a67d5fe0ab6cc45))
* **nojekyll:** add the --nojekyll arg to gh-pages instead of using a … ([7530c30](https://github.com/AEGIS-GAME/aegis/commit/7530c3027f52a9b59ec8dc395962e56ea5e8e0a3))
* **nojekyll:** add the --nojekyll arg to gh-pages instead of using a file ([c5d6135](https://github.com/AEGIS-GAME/aegis/commit/c5d613503abfce810bf00fc3d4945adff15bdc30))
* **nojekyll:** just add it in public folder ([259d9fa](https://github.com/AEGIS-GAME/aegis/commit/259d9fa1ae22c55cbb1f4294c204d3013f4a2e1f))
* **none path:** fix trying to unwrap a none type ([9abceda](https://github.com/AEGIS-GAME/aegis/commit/9abceda81fd6b5100463d1d3ae5aff5a2c4f8ddd))
* **observe result:** add handle observe result in brain file ([d48b125](https://github.com/AEGIS-GAME/aegis/commit/d48b1259e30f698d134fe3d9956ec31d8ea4fc2b))
* **observe result:** add handle observe result in brain file ([c8964df](https://github.com/AEGIS-GAME/aegis/commit/c8964dfd981e5241f420c106e6e1e3b91e59512b))
* **off by 1:** fix the off by 1 energy ([1fa6043](https://github.com/AEGIS-GAME/aegis/commit/1fa6043ce8bb91f9dd13ecf611cd92b3ae0f4493))
* **package tasks:** fix dev being a task already, changed to dev:a3 ([90622fd](https://github.com/AEGIS-GAME/aegis/commit/90622fdce31657d406ac5dee6bd928eb9e50a7c9))
* **page shift on open dialog:** improved the UI a little, and fixed the page shift issue ([c37cdd2](https://github.com/AEGIS-GAME/aegis/commit/c37cdd272e5be96d418c873eafd94e770f88cd09))
* **page shift on open dialog:** improved the UI a little, and fixed the page shift issue ([8e2949a](https://github.com/AEGIS-GAME/aegis/commit/8e2949a2cd0e9db457765de850af39bf120457ea))
* **paths :** fix href paths on buttons ([9c4918f](https://github.com/AEGIS-GAME/aegis/commit/9c4918f06e2e31c7e376a0b33c3acd08e59b14e2))
* **paths :** fix href paths on buttons ([832ee11](https://github.com/AEGIS-GAME/aegis/commit/832ee1187339927cbad23775b1e273d6960ba8cc))
* **paths:** remove extra docs folder ([9866e6b](https://github.com/AEGIS-GAME/aegis/commit/9866e6b683a99b0c7b5a88f1f538757f4818ae6c))
* **permissions:** add missing permissions ([512dbe1](https://github.com/AEGIS-GAME/aegis/commit/512dbe1f89ab8ea386307d087bc1624d4665ce8a))
* **permissions:** add write permissions ([9263cd7](https://github.com/AEGIS-GAME/aegis/commit/9263cd76e684d8f8c85ca29d982b5e9336a44cd4))
* **predict:** delete predict for imports so no numpy error for a1 ([3a89846](https://github.com/AEGIS-GAME/aegis/commit/3a8984693bdea508a3f411598c4dc87c2fbf2858))
* **release:** maybe this will have the client folder only have the clients... ([2974f8f](https://github.com/AEGIS-GAME/aegis/commit/2974f8f80aceac5d3c492c6caf936dc68b00ca42))
* **release:** need token ([1a1bf60](https://github.com/AEGIS-GAME/aegis/commit/1a1bf607608da037a464117c99b0ba7d5612eb0b))
* **round number:** increment at READ_MAIL state which is the actual start of round ([deac0fe](https://github.com/AEGIS-GAME/aegis/commit/deac0febfbeb182576b2366e14e60b794733cfc6))
* **run script:** fix run script name ([9b58c49](https://github.com/AEGIS-GAME/aegis/commit/9b58c4970e6aeba71ee4fedab5b246153f3b9b47))
* **search 2x popups:** hitting the keybind made it show twice ([db77a4f](https://github.com/AEGIS-GAME/aegis/commit/db77a4f31a3874748ea31a8e70e21fc68cdd0cef))
* **search 2x popups:** hitting the keybind made it show twice ([cc0f7ee](https://github.com/AEGIS-GAME/aegis/commit/cc0f7ee22669ce6acf8bdd28d2ece7c97d9dca5f))
* **search not showing results:** forgot to add the value attribute which actually renders results ([fce0d20](https://github.com/AEGIS-GAME/aegis/commit/fce0d201b19f364f67b439d9e241d2a027ba1a82))
* **search:** use correct index ([47cf3fb](https://github.com/AEGIS-GAME/aegis/commit/47cf3fbc2ab97ee249bdde1498b08d811d507703))
* **setup:** fix setup for unix ([a8837ba](https://github.com/AEGIS-GAME/aegis/commit/a8837bad4e11e5ed4f8dfa89a55e4cbb61700dd0))
* **setup:** fix version check and add better req install ([bdd880f](https://github.com/AEGIS-GAME/aegis/commit/bdd880fdaecdaedef5f837fd23f8d686cadab9d4))
* **setup:** setup should quit when trying to install client again ([04f2de1](https://github.com/AEGIS-GAME/aegis/commit/04f2de1409bfc3a6e8bf25c8b0b5d769b8ab5199))
* **shiki and eslit:** shiki fix and eslint ignore any in extract ([e90b8ed](https://github.com/AEGIS-GAME/aegis/commit/e90b8edae6806757ef26a4d405ee5fe8c2f5ebcb))
* **shiki and eslit:** shiki fix and eslint ignore any in extract ([bf92460](https://github.com/AEGIS-GAME/aegis/commit/bf9246030bffbaecd5e8c8ed2bbbfa932bb82c9a))
* **sidebar:** more minimal, didnt like the block and borders arounde each item ([0cbc145](https://github.com/AEGIS-GAME/aegis/commit/0cbc145c445f35ec5f1bb614bfb5bbcf39e3bb7c))
* **sidebar:** overflow fix ([c887c91](https://github.com/AEGIS-GAME/aegis/commit/c887c91f845eb09e75246e6ad8742f7e9b82493f))
* **sim:** send round 0 info so sim is the same as console ([63b1f25](https://github.com/AEGIS-GAME/aegis/commit/63b1f251a237e14c1c1e6612c8f03a2a602705f2))
* **socket:** same as a1 branch fix ([1fb3e0c](https://github.com/AEGIS-GAME/aegis/commit/1fb3e0cbf84df5c2c4dfe5719a73f2a65416b789))
* **space issue in path:** not docs related, but fix that ([27d0b06](https://github.com/AEGIS-GAME/aegis/commit/27d0b062ed1ad2d2c2bc9ecc47853c702af619bc))
* **spellcheck:** disable spellcheck for inputs ([d585414](https://github.com/AEGIS-GAME/aegis/commit/d585414451c7ebd30fe487ddaa9629c6db04effa))
* **steps taken:** add taht feature from a1 ([a6437da](https://github.com/AEGIS-GAME/aegis/commit/a6437daad5be34b2f6c8561716f13970dce180fc))
* **student maps:** energy level was 0, so observe never worked ([766e026](https://github.com/AEGIS-GAME/aegis/commit/766e026b318b90ef3e4196fcdbc84e981fcd92e3))
* **title admonition:** fix title and icon ([0210631](https://github.com/AEGIS-GAME/aegis/commit/02106313a6025dfc242e2c7abc359261b5c03b14))
* **title admonition:** fix title and icon ([fac5ae7](https://github.com/AEGIS-GAME/aegis/commit/fac5ae7487ca118df4dcf975ea6f3789692e25ef))
* **typo:** v2 -&gt; v1 ([a834ef8](https://github.com/AEGIS-GAME/aegis/commit/a834ef82de086f85207be52d31803b65c38c2ecd))
* **update has survivors:** set to false when all layers are cleared ([0aa3869](https://github.com/AEGIS-GAME/aegis/commit/0aa3869cb8d23c42b010180c816af77b57645fa0))
* **wait for client:** get rid of wait for client breaking client ([bf9123e](https://github.com/AEGIS-GAME/aegis/commit/bf9123e3031be22142a9a62b112905f1effada5f))
* **worfklow:** docs first ([4ee7432](https://github.com/AEGIS-GAME/aegis/commit/4ee743273a0c454da8e3fb0f02d168693a63403d))
* **workflow node:** node 18 -&gt; 20 ([8a57ae8](https://github.com/AEGIS-GAME/aegis/commit/8a57ae8553429bb5478391d63bd0ccace55ebc16))
* **workflow sub:** fix github.ref in bash stuff ([c7d48bb](https://github.com/AEGIS-GAME/aegis/commit/c7d48bbb5562693202f748b81e5363fdff4c8597))
* **workflow:** docs branch ([ca523a7](https://github.com/AEGIS-GAME/aegis/commit/ca523a73c4b524f27ca08fa814649856bf1a325f))
* **workflow:** fix platforms building for other platforms ([c8655fd](https://github.com/AEGIS-GAME/aegis/commit/c8655fd6e070160056f12009e4d4626c99332117))
* **workflow:** fix prev workflow ([264b4d0](https://github.com/AEGIS-GAME/aegis/commit/264b4d09b7fce77c59c3d5cd8eb57313afaf546f))
* **workflow:** matrix to env ([ca9aba0](https://github.com/AEGIS-GAME/aegis/commit/ca9aba0a46b9431bd95363d264a82a5f902c9b62))
* **workflow:** strings ([fdf897b](https://github.com/AEGIS-GAME/aegis/commit/fdf897b118d09c1d90ce00e8edfbacca76a92707))
* **workflow:** working dir for linux zip ([0ef8126](https://github.com/AEGIS-GAME/aegis/commit/0ef8126aed75ec1a073659a018d4105f75987fab))


### Documentation

* **a lot:** changed A LOT in the docs ([9483a96](https://github.com/AEGIS-GAME/aegis/commit/9483a96caee62795f3b5bbc3ffcf7b2ba9e9e54a))
* **a1 api content and other small fixes:** add the a1 api stuff, and fix a few more thigns ([d796972](https://github.com/AEGIS-GAME/aegis/commit/d796972688b357bc95ca6751de1acd5d3dd493f4))
* **a1 config:** add warning admonition ([1da497b](https://github.com/AEGIS-GAME/aegis/commit/1da497ba08d11ecd28d1e2d19cd9a2241b17508a))
* **a1:** add a1 config and more info ([1a43b43](https://github.com/AEGIS-GAME/aegis/commit/1a43b43b78cf96229dc4ccd520d79ad4813e6b07))
* **acknowledgments page:** finally added the acknowledgments page after janet told me 3 months ago ([b68dde1](https://github.com/AEGIS-GAME/aegis/commit/b68dde1b8e78ff41e3334a24275054dfbe1e0860))
* **add a footer:** add a footer made by goob ([95043a4](https://github.com/AEGIS-GAME/aegis/commit/95043a4c777550c7cfc7ba1b262c09b9f2a8ac2e))
* **add missing functions:** . ([e542919](https://github.com/AEGIS-GAME/aegis/commit/e54291965bfa9b766c0cb79c8b797f195dad35b5))
* **add ruble :** add rubble docs ([ef7f647](https://github.com/AEGIS-GAME/aegis/commit/ef7f64750b1f5c28cc05504f7c15e76e5424af90))
* **add ruble :** add rubble docs ([48a3834](https://github.com/AEGIS-GAME/aegis/commit/48a3834f3fcec57ade288d68cca2ca20c85f0259))
* **aegis system:** remove state commands ([ec64331](https://github.com/AEGIS-GAME/aegis/commit/ec6433195b9ee6ac03fef5c68bd9dd4c601aed6b))
* **api and clean:** add api docs and remove things students will never use ([d08376a](https://github.com/AEGIS-GAME/aegis/commit/d08376a6c1a8f6e84a8b4d433331f2f4045ee387))
* **center direction:** for some reason this was never added ([65366be](https://github.com/AEGIS-GAME/aegis/commit/65366be1c9e367c5f322af28a8b542e989e2e277))
* **change 3.12.x to 3.12.9:** versions before 3.12.9 had so many issues ([94e353b](https://github.com/AEGIS-GAME/aegis/commit/94e353b803edfa85ed7e7daabc2a73e927714d73))
* **change some stuff:** . ([51de0ea](https://github.com/AEGIS-GAME/aegis/commit/51de0ea18ceabf2327ee152b3e52ec736d7ac030))
* **clone step:** add a clone step and refactor some stuff ([b7c0de9](https://github.com/AEGIS-GAME/aegis/commit/b7c0de9c2e5cdf89d817bb1bfa7f1313d7a21356))
* **content tab:** make content tabs for OS platforms ([d07e14e](https://github.com/AEGIS-GAME/aegis/commit/d07e14e2714e268621eae91e6ea634a5b85a78c2))
* **contributing:** add a contributing.md file ([#268](https://github.com/AEGIS-GAME/aegis/issues/268)) ([7969340](https://github.com/AEGIS-GAME/aegis/commit/796934039c0c14a23a86fecc637e7b40ea35848f))
* **disable world objects for a1:** . ([663bc8f](https://github.com/AEGIS-GAME/aegis/commit/663bc8ff098ce0e2a4306d43ea1ac6b5cf3329d8))
* **docs:** add link to running aegis and add photos for mac ([2909fac](https://github.com/AEGIS-GAME/aegis/commit/2909fac99a7fa768737459c2d3f2a7bd4f3de376))
* **docs:** add search feature and better a1_config code block ([91d369a](https://github.com/AEGIS-GAME/aegis/commit/91d369a0551cde21c9d104d903b9a26b1f588eb0))
* **docs:** docs update ([05ea0f6](https://github.com/AEGIS-GAME/aegis/commit/05ea0f6dd265cfda2ae7f015124686be1818f54a))
* **docs:** move mkdocs.yml to root ([fc84141](https://github.com/AEGIS-GAME/aegis/commit/fc841415cc6768d53d3f7546a6967073f55c251a))
* **fix clone location:** add it after setting up the whole repo ([8bfc2fb](https://github.com/AEGIS-GAME/aegis/commit/8bfc2fb3cca0f04483d36cea59bc41631bf20ebb))
* **fix clone location:** add it after setting up the whole repo ([3b0fe69](https://github.com/AEGIS-GAME/aegis/commit/3b0fe69a64b964133633cf4a405d42a887b733db))
* **fix return type:** return type for distance_to was wrong ([451fe42](https://github.com/AEGIS-GAME/aegis/commit/451fe42f1d9182ca8799537b464ea5a26c5f8b16))
* **fix:** typo ([4c96dde](https://github.com/AEGIS-GAME/aegis/commit/4c96dde80eda0df6b80398fa275c0355759d26a9))
* **git:** add install git step and some additional helpful info ([0bbe891](https://github.com/AEGIS-GAME/aegis/commit/0bbe8916a7de70cf5169ce6be6c531cc208c79de))
* **headers:** remove assignment 1 headers ([6acf109](https://github.com/AEGIS-GAME/aegis/commit/6acf109a0f70a9109ed017d0bf03ec8162108c37))
* **hide functions:** hide functions from docs that students don't need ([59436ab](https://github.com/AEGIS-GAME/aegis/commit/59436abf96add97e2fd75617e6aadf514f90d3b2))
* **hide:** another function ([4f45791](https://github.com/AEGIS-GAME/aegis/commit/4f457910a04008bf56e6b833416bca6a12672d5c))
* **how to section:** add a how to section, that has nothing for now ([3cbeb3c](https://github.com/AEGIS-GAME/aegis/commit/3cbeb3c2f4207b7704a0a126c9d65d84f9d25dc3))
* **hyperlink footers:** remove them ([40a70bc](https://github.com/AEGIS-GAME/aegis/commit/40a70bc6e2db379c8fc54e66cbe639882b5e13e4))
* **icons:** add icons ([61bee25](https://github.com/AEGIS-GAME/aegis/commit/61bee25815a8f94efe5e928abfbf374faa0c7b4d))
* **icons:** add icons to the docs ([01c87b4](https://github.com/AEGIS-GAME/aegis/commit/01c87b4c6047bedff665916389b2cf1d7ebcc47f))
* **icons:** change icons in home page ([a837731](https://github.com/AEGIS-GAME/aegis/commit/a83773194af98a1bbfc9d3dc0beb9f0ddd76f773))
* **improve common erros UI :** docs(improve common erros UI ):  ([5873c76](https://github.com/AEGIS-GAME/aegis/commit/5873c760cc3aaedba51275f51fc4efb5a72ab1b4))
* **intro guides page:** add a short intro ([be59e80](https://github.com/AEGIS-GAME/aegis/commit/be59e80366d04a6d0e1fc99e22d0a636d6b24a03))
* **linux guide:** add clean up step ([c817dc6](https://github.com/AEGIS-GAME/aegis/commit/c817dc6bc71c83a9d544e3c0f4c165e611398719))
* **mobile nav:** add to all pages ([95f5ab1](https://github.com/AEGIS-GAME/aegis/commit/95f5ab179a2a286e4751c6ead61e8a0c98c47efd))
* **more:** . ([0e22d42](https://github.com/AEGIS-GAME/aegis/commit/0e22d426b7d5b58447cdded4eae6dea8b1f1799a))
* **move files around:** better placement of files, suggested by Xanna ([d10a292](https://github.com/AEGIS-GAME/aegis/commit/d10a292b3c509c754eae4f3806b73acb9848a844))
* **nice stuff:** . ([7deccfb](https://github.com/AEGIS-GAME/aegis/commit/7deccfba51fb263aa942e8233bf9a3e41905bc88))
* **no layers:** delete no layers stuff ([d383511](https://github.com/AEGIS-GAME/aegis/commit/d38351126e7553f9246d4759e8a78915171a51a1))
* **note:** existing tags ([8988199](https://github.com/AEGIS-GAME/aegis/commit/8988199d8aadebe291648ea03e229eccf585a592))
* **outdated:** update outdated info ([e510201](https://github.com/AEGIS-GAME/aegis/commit/e5102010fb9cc3c71b390cbc1477f20acdabaa50))
* **predict:** add predict info ([b8bdfae](https://github.com/AEGIS-GAME/aegis/commit/b8bdfae20cb6dbfa8340946dc991cdf4bfd591dd))
* **predict:** add predict to missing files, and sort agent commands ([00ba249](https://github.com/AEGIS-GAME/aegis/commit/00ba2498183bda63140e312cc02ff77d8331fbfd))
* **predict:** predict docs ([394c81d](https://github.com/AEGIS-GAME/aegis/commit/394c81de4b517036925f7d3a0e375ee75c615f55))
* **predict:** predict stuff ([3eaf278](https://github.com/AEGIS-GAME/aegis/commit/3eaf2783a00c3e6490d081ae032d9d581396167b))
* **python linux guide:** make the linux guide ([6bc63cc](https://github.com/AEGIS-GAME/aegis/commit/6bc63cc85c6434fc3b1725a95d3745d814e38ce1))
* **python mac guide:** make the mac guide ([1fd6352](https://github.com/AEGIS-GAME/aegis/commit/1fd6352294350e1f751649f338a4ee9f8c6f487f))
* **python windows guide:** make the windows guide ([af3a48f](https://github.com/AEGIS-GAME/aegis/commit/af3a48fede1c751a6933c01bfac5bb320cee7083))
* **readme and src:** add readmes and move stuff out of the src folder for docs ([d4a86f0](https://github.com/AEGIS-GAME/aegis/commit/d4a86f0c346ada1bbf1f094a52f333a8dbec6cb9))
* **readme:** add docs branch warning ([09472c0](https://github.com/AEGIS-GAME/aegis/commit/09472c0907bed34475688de1e4e5c2182b924f70))
* **readme:** add readme ([1b66b84](https://github.com/AEGIS-GAME/aegis/commit/1b66b84a3012345fb2d7389a2e1b7a3f2f552b4f))
* **readme:** update branch ([99cebaf](https://github.com/AEGIS-GAME/aegis/commit/99cebaf03d7ad683565ec7cb66a7110ac6cc269c))
* **removed header border, and change md to lg-custom:** . ([a3acee7](https://github.com/AEGIS-GAME/aegis/commit/a3acee7af2d9e4f8213ea08d7b60615b2ab2cd72))
* **responsive nav:** made a responsive nav, just need to add it to all pages ([635838c](https://github.com/AEGIS-GAME/aegis/commit/635838c58723bed08373e48288d1f0e1515bba07))
* **running:** change small detail in text ([cd822cb](https://github.com/AEGIS-GAME/aegis/commit/cd822cb5c1fe0aa7bf7817c828f1f3dbc553e24c))
* **shadcn:** add shadcn components to make the UI cleaner ([88a1427](https://github.com/AEGIS-GAME/aegis/commit/88a14276ad78c3bd8d1b950b9a48f8a5665956c6))
* **sleep amount:** add sleep recharge amount to docs ([61f637c](https://github.com/AEGIS-GAME/aegis/commit/61f637c597481db15f4cfc3f2196765d01efb993))
* **sleep amount:** add sleep recharge amount to docs ([fe60905](https://github.com/AEGIS-GAME/aegis/commit/fe60905d12f40eaf327803d485a4ace8941c086f))
* **small things:** readme stuff ([18031de](https://github.com/AEGIS-GAME/aegis/commit/18031de17d5b67ee0d2ad2142bf13d923795ee71))
* **todo comment:** add todo for reminder on export dialog ([441bf4d](https://github.com/AEGIS-GAME/aegis/commit/441bf4da8062fd9a33d8e284095353bf338fc425))
* **typo:** fix typo ([2148e47](https://github.com/AEGIS-GAME/aegis/commit/2148e47ee46dd74843520ce7ec251f4a38cf89eb))
* **update common issues:** fix some formatting and explanation ([e0f6ddf](https://github.com/AEGIS-GAME/aegis/commit/e0f6ddf0e9c7a0ee15ad1c7061ce24e3dc55e0ec))
* **update docs:** remove parts taht say to only open client from terminal ([35b732a](https://github.com/AEGIS-GAME/aegis/commit/35b732ade8183b378092e9ce560e946e7dd0184f))
* **update readme:** docs(update readme):  ([3225ce4](https://github.com/AEGIS-GAME/aegis/commit/3225ce4f3d26be42e68b9eb3a9ece9c2c2191ed2))
* **update sleep and life signals:** better docs for life signals and sleep ([f99f215](https://github.com/AEGIS-GAME/aegis/commit/f99f2150187e997c068e699bf12b03d99332d1f1))
* **workflows:** remove docs from release zip ([13bd3b9](https://github.com/AEGIS-GAME/aegis/commit/13bd3b90fd7d9cd9bce3ed841c8bfdc7bb95b0d8))
