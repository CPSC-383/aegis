...
class Turn(_message.Message):
    __slots__ = ("agentId", "energy_level", "steps_taken", "loc", "commands")
    ...
    def __init__(self, agentId: _Optional[int] = ..., energy_level: _Optional[int] = ..., steps_taken: _Optional[int] = ..., loc: _Optional[_Union[_location_pb2.Location, _Mapping]] = ..., commands: _Optional[_Iterable[str]] = ...) -> None: ...
