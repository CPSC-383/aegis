...
class Spawn(_message.Message):
    __slots__ = ("agentId", "loc", "team", "amount")
    ...
    team: _team_pb2.Team
    amount: int
    def __init__(self, agentId: _Optional[int] = ..., loc: _Optional[_Union[_location_pb2.Location, _Mapping]] = ..., team: _Optional[_Union[_team_pb2.Team, str]] = ..., amount: _Optional[int] = ...) -> None: ...
