...
import { whatBucket } from "@/utils/utils";
...
export class WorldMap {
  ...
  constructor(
    ...
    public readonly spawnCells: Map<
      string,
      { type: SpawnZoneTypes; groups: number[] }
    >,
  ...
  isEmpty(): boolean {
    return (
      ...
      this.stacks.every(
        (stack) => stack.contents.length === 0 && stack.move_cost === 1,
      )
    );
  }
