...
class Cell(_message.Message):
    ...
    def __init__(self, loc: _Optional[_Union[_common_pb2.Location, _Mapping]] = ..., move_cost: _Optional[int] = ..., type: _Optional[_Union[CellType, str]] = ..., agents: _Optional[_Iterable[int]] = ..., layers: _Optional[_Iterable[_Union[_world_object_pb2.WorldObject, _Mapping]]] = ...) -> None: ...
